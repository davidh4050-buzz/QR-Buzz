...
class HostedAppController {
    ...
    private function downloadUrl(int $id, string $format): string { $format = $format === 'svg' ? 'svg' : 'png'; return wp_nonce_url(home_url('/app/qr/' . $id . '/download/' . $format), 'qrbuzz_app_download_' . $id); }
